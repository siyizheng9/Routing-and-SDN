...
sudo cp Aalto/ospfd.conf /var/lib/lxc/Aalto/rootfs/etc/quagga/ospfd.conf
...
sudo cp Funet/daemons_ospf /var/lib/lxc/Funet/rootfs/etc/quagga/daemons
...
sudo cp Comnet/ospfd.conf /var/lib/lxc/Comnet/rootfs/etc/quagga/ospfd.conf
